$(function () {
  ...
  $(window).on("scroll", function () {
    ...
    new Swiper(".mil-reviews-slider", {
      ...
      speed: 800,
      parallax: !0,
      navigation: { prevEl: ".mil-reviews-prev", nextEl: ".mil-reviews-next" },
      pagination: {
    ...
    $(".mil-filter a").on("click", function () {
      ...
      return $(".mil-portfolio-grid").isotope({ filter: e }), !1;
    }),
      ...
      $("#cform-two").validate({
        ...
        submitHandler: function () {
          $.ajax({
            ...
            data:
              "name=" +
              $("#cform-two").find('input[name="name"]').val() +
              "&email=" +
              $("#cform-two").find('input[name="email"]').val() +
              "&message=" +
              $("#cform-two").find('textarea[name="message"]').val(),
            beforeSend: function () {},
            complete: function () {},
            success: function (e) {
              $("#cform-two").fadeOut(),
